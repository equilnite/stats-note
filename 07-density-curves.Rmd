...
-Remember that with right skewed data, the $mean > median$

-Remember that with left skewed data, the $mean < median$

-Remember that with symmetric data, the $mean \cong median$
...
::: {.highlight}
The Empirical Rule (68-95-99.7 Rule) tells us that:
