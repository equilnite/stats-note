...
::: {.callout-important title="Conditions for $\chi^2$"}
...
If you are checking to see if something matches up with something as a *one-way* comparison, then this is the right test to name.
:::
...
{{< video https://www.youtube.com/watch?v=gYFhQZ5gqPs >}}
...
This test is appropriate if you are considering a multi-way comparison.
:::
...
{{< video https://www.youtube.com/watch?v=XIE4hLBv13Y >}}
