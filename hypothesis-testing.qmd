...
::: {.callout-important title="The null and alternative hypotheses"}
...
::: {.callout-tip title="One-sided versus Two-sided"}
...
::: {.callout-note title="Conclusion of a hypothesis test"}
...
::: {.callout-note title="Type I Error probability"}
...
::: {.callout-note title="Power and Type II Error probability"}
