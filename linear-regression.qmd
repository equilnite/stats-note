...
::: {.callout-note title="The least squares regression model"}
...
::: {.callout-important title="Interpretation of a regression line"}
...
::: {.callout-important title="Properties of the Correlation Coefficient $r$"}
...
::: {.callout-important title="Points of Caution for Residual Plots"}
...
Remember, an outlier is an observation that lies outside the overall pattern of other observations.
...
::: {.callout-important title="Influential Observations"}
...
We are able to classify influential observations into two kinds:

1. High Leverage: "outliers" in the x-direction. These are points that are far from main cluster(s) of points in the horizontal direction. They tend to be points that influence almost all aspects of a regression line.

2. Outliers: outliers in the y-direction. These are points that are far from main cluster(s) of points in the vertical direction. They tend to be points that influence mostly only $r$, the correlation coefficient.

Make sure to call high leverage points "high leverage" and not "outliers"! If applicable, points may be both a high leverage point and an outlier.
...
Child 18 is a high leverage point and is the most influential observation on the regression line itself. Notice how removing (and adding) child 18 caused the greatest change in the regression line. 

Child 19 is an outlier and is the most influential observation on the correlation coefficient, $r$. Notice how removing (and adding) child 19 caused the greatest change in $r$
