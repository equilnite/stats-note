...
::: {.highlight}
If the *P*-value is smaller than alpha, we say that the data are statistically significant at the level . In that case, we reject the null hypothesis $H_0$ and conclude that there is convincing evidence in favor of the alternative hypothesis $H_a$.
