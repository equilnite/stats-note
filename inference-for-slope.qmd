...
::: {.callout-note title="Sampling Distribution of $b$"}
...
::: {.callout-important title="Five Conditions for Slope Inference"}
...
::: {.callout-note title="Standard Error of $b$"}
...
::: {.callout-note title="$t$-interval for $\beta$"}
...
::: {.callout-note title="$t$-test for  $\beta$"}
...
::: {.callout-important}
To reiterate, from this computer output, we can figure out that for a significance test for $\beta$ with this data,
...
Other parts to the output are irrelevant to this course.
:::
