...
Plot.plot({
  marks: [
    ...
    Plot.ruleX([critical_val(C)[0]]),
    Plot.text([{"x": critical_val(C)[0] + 0.4, "y": 0.35}, {"x": 2.5, "y":0.4}], {x: "x", y:"y", text: ["-|z*| = " + critical_val(C)[0].toFixed(2), "Area to the left = " + "(1 - " + C/100 + ") / 2 = " + ((1-C/100)/2).toFixed(4)]})
  ],
...
Plot.plot({
  marks: [
    ...
    Plot.ruleX([critical_val(C)[1]]),
    Plot.text([{"x": critical_val(C)[1] - 0.4, "y": 0.35}, {"x": -2.5, "y": 0.4}], {x: "x", y:"y", text: ["|z*| = " + critical_val(C)[1].toFixed(2), "Area to the left = " + C/100 + " + (1 - " + C/100 + ") / 2 = " + (C/100 + (1-C/100)/2).toFixed(4)]})
  ],
